package io.practor.app.repository;

import io.practor.app.PractorApp;
import io.practor.app.config.Constants;
import io.practor.app.config.audit.AuditEventConverter;
import io.practor.app.domain.PersistentAuditEvent;
...
import static io.practor.app.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
